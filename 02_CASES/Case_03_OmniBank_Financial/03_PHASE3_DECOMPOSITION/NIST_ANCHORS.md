...
| CR-D-02.2-001 | PR.PS-02 | ALT-ANCHOR (SSDF PS.1; 800-53r5 SI-2) (no PF 1.0 analogue for product patch and OTA update management) | MANAGE-2.3 | PARTIAL |
...
| CR-D-03.2-001 | PR.AA-03 | ALT-ANCHOR (800-53r5 IA-2(1); ASVS V3.3) (no PF 1.0 MFA subcategory) | N/A (non-AI scope) | PARTIAL |
...
| CR-D-04.4-001 | RC.RP-01; RC.RP-03; RC.RP-05 | ALT-ANCHOR (800-53r5 CP-9; CP-10) (no PF 1.0 backup and DR recovery subcategory) | MANAGE-2.3 <!-- U1 fill: RECOVER-1.* not in AI RMF 1.0; substituted MANAGE-2.3 --> | PARTIAL |
...
| CR-D-06.4-001 | DE.CM-06; PR.IR-01 | ALT-ANCHOR (800-53r5 PE-3; PE-6) (no PF 1.0 analogue for third-party boundary isolation) | N/A (non-AI scope) | PARTIAL |
| CR-D-07.1-001 | PR.PS-06; ID.RA-01 | GV.PO-P2; CT.PO-P4; CT.DP-P2; CT.DP-P5 | N/A (non-AI scope) | PARTIAL |
| CR-D-07.2-001 | PR.PS-06 | ALT-ANCHOR (SSDF PW.1; 800-53r5 SA-8) (no PF 1.0 secure-SDLC subcategory) | N/A (non-AI scope) | PARTIAL |
...
| CR-D-08.3-001 | GV.RR-01; PR.AT-02 | ALT-ANCHOR (SAMM G-EG-A-1; 800-53r5 AT-2) (no PF 1.0 board-training subcategory) | N/A (non-AI scope) | PARTIAL |
...
| CR-D-10.3-001 | ID.IM-01; ID.IM-02; ID.IM-03 | ALT-ANCHOR (800-53r5 CA-2; CA-7) (no PF 1.0 compliance-testing subcategory) | MEASURE-1.1; MEASURE-2.1; MEASURE-2.3; MEASURE-2.7; MAP-3.3 | PARTIAL |
...
| BPR-D-02.3-001 | ALT-ANCHOR (SSDF PW.7; 800-53r5 RA-5; SAMM V-ST-A) (no PF 1.0 analogue for CVD best practice) | N/A (non-AI scope) | ALT-ANCHOR (SSDF PW.7; 800-53r5 RA-5; SAMM V-ST-A) (no PF 1.0 analogue for CVD best practice) | N/A (non-AI scope) |
...
| BPR-D-03.2-001 | ALT-ANCHOR (800-53r5 IA-2(1); ASVS V3.3) (no PF 1.0 MFA subcategory — best practice) | N/A (non-AI scope) | ALT-ANCHOR (800-53r5 IA-2(1); ASVS V3.3) (no PF 1.0 MFA subcategory — best practice) | N/A (non-AI scope) |
...
| BPR-D-04.4-001 | ALT-ANCHOR (800-53r5 CP-9; CP-10) (no PF 1.0 backup and DR recovery subcategory — best practice) | N/A (non-AI scope) | ALT-ANCHOR (800-53r5 CP-9; CP-10) (no PF 1.0 backup and DR recovery subcategory — best practice) | N/A (non-AI scope) |
...
| BPR-D-06.4-001 | ALT-ANCHOR (800-53r5 PE-3; PE-6) (no PF 1.0 analogue for third-party boundary isolation — best practice) | N/A (non-AI scope) | ALT-ANCHOR (800-53r5 PE-3; PE-6) (no PF 1.0 analogue for third-party boundary isolation — best practice) | N/A (non-AI scope) |
| BPR-D-07.1-001 | GV.PO-P2; CT.PO-P4; CT.DP-P2; CT.DP-P5 | N/A (non-AI scope) | GV.PO-P2; CT.PO-P4; CT.DP-P2; CT.DP-P5 | N/A (non-AI scope) |
| BPR-D-07.2-001 | ALT-ANCHOR (SSDF PW.1; 800-53r5 SA-8) (no PF 1.0 secure-SDLC subcategory — best practice) | N/A (non-AI scope) | ALT-ANCHOR (SSDF PW.1; 800-53r5 SA-8) (no PF 1.0 secure-SDLC subcategory — best practice) | N/A (non-AI scope) |
...
| BPR-D-08.3-001 | ALT-ANCHOR (SAMM G-EG-A-1; 800-53r5 AT-2) (no PF 1.0 board-training subcategory — best practice) | N/A (non-AI scope) | ALT-ANCHOR (SAMM G-EG-A-1; 800-53r5 AT-2) (no PF 1.0 board-training subcategory — best practice) | N/A (non-AI scope) |
...
| BPR-D-10.3-001 | ALT-ANCHOR (800-53r5 CA-2; CA-7) (no PF 1.0 compliance-testing subcategory — best practice) | N/A (non-AI scope) | ALT-ANCHOR (800-53r5 CA-2; CA-7) (no PF 1.0 compliance-testing subcategory — best practice) | N/A (non-AI scope) |
