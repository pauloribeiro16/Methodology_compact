...
Columns: `Sub-domain | I | P | Tier | satisfaction_pattern | evidence_depth | verification_method | ownership | example_controls | Risk if not met | Impl. Status (backfilled) | Implementation Priority | Notes`.
...
|------------|---|---|---|------|-----------|
| D-01.1 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS | HIGH | PARTIAL | CRITICAL |
| D-01.2 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS | HIGH | PARTIAL | CRITICAL |
| D-01.3 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS | MEDIUM | PARTIAL | CRITICAL |
| D-01.4 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS | MEDIUM | PARTIAL | HIGH |
| D-02.1 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS | HIGH | PARTIAL | CRITICAL |
| D-02.2 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS | HIGH | PARTIAL | CRITICAL |
| D-02.3 | MAX | INHERITABLE | MUST | STANDARD | §5.1 row MAX col INHERITABLE = STANDARD (CVD static infrastructure) | MEDIUM | PARTIAL | HIGH |
| D-02.4 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (DORA Art. 26-27 TLPT) | HIGH | PARTIAL | CRITICAL |
| D-03.1 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (dedicated IAM) | HIGH | PARTIAL | CRITICAL |
| D-03.2 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (dedicated MFA) | HIGH | PARTIAL | CRITICAL |
| D-03.3 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (dedicated RBAC/ABAC) | HIGH | PARTIAL | CRITICAL |
| D-03.4 | MAX | INHERITABLE | MUST | STANDARD | §5.1 row MAX col INHERITABLE = STANDARD (CIS-benchmark defaults) | MEDIUM | PARTIAL | HIGH |
| D-04.1 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (24/7 SOC) | HIGH | PARTIAL | CRITICAL |
| D-04.2 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (dedicated IR team) | HIGH | PARTIAL | CRITICAL |
| D-04.3 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (5-reg max-SLA routing) | HIGH | PARTIAL | CRITICAL |
| D-04.4 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (own DR programme) | HIGH | PARTIAL | CRITICAL |
| D-05.1 | MAX | INHERITABLE | MUST | STANDARD | §5.1 row MAX col INHERITABLE = STANDARD (DB-level minimisation) | MEDIUM | PARTIAL | HIGH |
| D-05.2 | MAX | INHERITABLE | MUST | STANDARD | §5.1 row MAX col INHERITABLE = STANDARD (archive tooling) | MEDIUM | PARTIAL | HIGH |
| D-05.3 | MAX | INHERITABLE | MUST | STANDARD | §5.1 row MAX col INHERITABLE = STANDARD (erasure API endpoint) | HIGH | PARTIAL | HIGH |
| D-05.4 | MAX | INHERITABLE | MUST | STANDARD | §5.1 row MAX col INHERITABLE = STANDARD (JSON export) | MEDIUM | PARTIAL | MEDIUM |
| D-06.1 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (own vendor risk + DORA Art. 28) | HIGH | PARTIAL | CRITICAL |
| D-06.2 | MAX | INHERITABLE | MUST | STANDARD | §5.1 row MAX col INHERITABLE = STANDARD (machine-readable SBOM format in CI/CD) | MEDIUM | PARTIAL | HIGH |
| D-06.3 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (own contract templates + DORA Art. 30) | HIGH | PARTIAL | CRITICAL |
| D-06.4 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (own boundary management + DORA Art. 28 exit) | HIGH | PARTIAL | CRITICAL |
| D-07.1 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (NIST SSDF + OWASP SAMM Level 3) | HIGH | PARTIAL | CRITICAL |
| D-07.2 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (SAST blocking merge) | HIGH | PARTIAL | CRITICAL |
| D-07.3 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (own CI/CD + SLSA Level 3) | HIGH | PARTIAL | CRITICAL |
| D-07.4 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (DORA Art. 10 change management) | HIGH | PARTIAL | CRITICAL |
| D-08.1 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (dedicated awareness programme) | MEDIUM | PARTIAL | HIGH |
| D-08.2 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (role-based training) | MEDIUM | PARTIAL | HIGH |
| D-08.3 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (NIS 2 management liability) | HIGH | PARTIAL | CRITICAL |
| D-09.1 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (full ISMS + DORA Art. 5 + AI Act) | HIGH | PARTIAL | CRITICAL |
| D-09.2 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (IPSARA unified assessment) | HIGH | PARTIAL | CRITICAL |
| D-09.3 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (DORA Art. 8 ICT inventory) | HIGH | PARTIAL | CRITICAL |
| D-09.4 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (RoPA + DORA records) | HIGH | PARTIAL | CRITICAL |
| D-10.1 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (24/7 SOC + DORA Art. 13) | HIGH | PARTIAL | CRITICAL |
| D-10.2 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (DORA Art. 12 records + WORM) | HIGH | PARTIAL | CRITICAL |
| D-10.3 | MAX | BUILD_REQUIRED | MUST | RIGOROUS | §5.1 row MAX col BUILD_REQUIRED = RIGOROUS (DORA Art. 24-27 + AI Act Art. 43) | HIGH | PARTIAL | CRITICAL |
