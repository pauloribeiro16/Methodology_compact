...
inactive_documented: []
inputs: [04_Company_Context_Assessment.md, 02_Regulatory_Mapping_Master.xlsx]
outputs: [06_Clause_Mapping_Matrix.md]
traceability: AEGIS Class Model → ComplianceContext, RegulatoryClause classes
related_documents: [00_Taxonomy_Reference.md, 04_Company_Context_Assessment.md, 06b_DORA_ICT_Risk_Framework.md]
sibling_of: ../01_PHASE1_CONTEXT/05_Regulatory_Applicability.md
reconciliation_notes:
  - "Sprint 1 (2026-08-06): Copied from 01_PHASE1_CONTEXT/05_Regulatory_Applicability.md → Rich folder; frontmatter migrated to AEGIS-P3-RICH-* prefix; status DRAFT → RECONCILED; outputs updated from .xlsx → .md (06_Clause_Mapping_Matrix.md is now a Markdown companion — generated by Sprint 1 Task 1.4). Sections 5.3 (Compliance Boundary Diagram) + 9 (KEY OBSERVATIONS) preserved as case-specific extensions (by-design for MAX). Body unchanged from legacy v1.2 (last canonical). DORA + AI Act cross-references enriched to include 06b_DORA_ICT_Risk_Framework.md."
---

<!-- RECONCILED (Sprint 1, 2026-08-06): Document copied from legacy 01_PHASE1_CONTEXT/05_Regulatory_Applicability.md to Rich folder.
Changes: (a) document_id migrated to AEGIS-P3-RICH-05-APP; (b) status DRAFT → RECONCILED;
(c) outputs updated: 06_Clause_Mapping_Matrix.xlsx → 06_Clause_Mapping_Matrix.md (Sprint 1 generates the .md companion — I-C03-01 RESOLVED);
...
(e) DORA + AI Act references enriched to cross-link 06b_DORA_ICT_Risk_Framework.md.
