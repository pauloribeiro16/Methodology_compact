---
document_id: AEGIS-P3-RICH-00-TAX
title: Security Control Domain Taxonomy Reference (Rich Mode)
phase: 1
version: 1.1
created: 2026-04-01
updated: 2026-08-06
author: AEGIS Research Team (Sprint 1 reconciliation copy)
status: RECONCILED
...
<!-- RECONCILED (Sprint 1, 2026-08-06): Document copied from legacy 00_COMMON/00_Taxonomy_Reference.md to Rich folder.
Changes: (a) document_id migrated to AEGIS-P3-RICH-00-TAX (P3 = Case_03 prefix); (b) status DRAFT → RECONCILED;
(c) active_subdomains: 38 confirmed for Case_03 MAX (all 5 regs applicable); (d) sibling_of cross-reference added.
Body content unchanged — taxonomy is canonical and frozen at v1.0.
-->
...
|-----------|-------------|------------------|---------------------------|
| D-01 | Data Protection & Encryption | 4 | GDPR, CRA, DORA |
| D-02 | Vulnerability Management | 4 | CRA, DORA, NIS 2 |
| D-03 | Access Control | 4 | GDPR, NIS 2, DORA |
| D-04 | Incident Response | 4 | GDPR, NIS 2, CRA, DORA |
...
| D-10 | Monitoring & Audit | 3 | DORA, AI Act, NIS 2 |
...
| Sub-Domain ID | Sub-Domain Name | Regulatory Driver | Normative Intensity (Max) | Sole Authority? |
|---------------|-----------------|-------------------|---------------------------|-----------------|
| D-02.1 | Vulnerability Identification | CRA-C01/C17, DORA-C08, NIS2-C12, AI-C03/C16 | 3.000 | No |
| D-02.2 | Patch Management & Updates | CRA-C04/C19, DORA-C13/C26, NIS2-C12 | 3.000 | No |
...
| Sub-Domain ID | Sub-Domain Name | Regulatory Driver | Normative Intensity (Max) | Sole Authority? |
|---------------|-----------------|-------------------|---------------------------|-----------------|
| D-03.1 | Identity Lifecycle Management | CRA-C05, DORA-C15, NIS2-C19, AI-C15 | 3.000 | No |
| D-03.2 | Multi-Factor Authentication | CRA-C06, DORA-C16, NIS2-C21, AI-C15 | 3.000 | No |
...
| Sub-Domain ID | Sub-Domain Name | Regulatory Driver | Normative Intensity (Max) | Sole Authority? |
|---------------|-----------------|-------------------|---------------------------|-----------------|
| D-04.1 | Incident Detection & Triage | CRA-C13, DORA-C21/C30, NIS2-C28/C29, AI-C25 | 3.000 | No |
...
| D-07.2 | Secure Coding Practices | DORA-C19, CRA-C02, NIS2-C11 | 3.000 | No |
| D-07.3 | CI/CD Pipeline Security | NIS2-C11, DORA-C20 | 3.000 | No |
| D-07.4 | Change Management | DORA-C06, NIS2-C10 | 3.000 | No |
...
| D-09.3 | Asset Inventories | DORA-C05, NIS2-C07 | 3.000 | No |
...
**Total:** 4/38 sub-domains (10.5%) have sole authority when all 5 regulations apply

**Note:** With all 5 regulations applicable (OmniBank case), most sub-domains have overlapping coverage. Only 4 sub-domains remain with sole authority (all CRA-exclusive). D-02.4 (TLPT) is covered by both DORA (DORA-C34) and AI Act (AI-C04) — not sole authority.

### 4.2 OmniBank-Specific Sole Authority (All 5 Regulations Apply)

Since OmniBank Financial Systems has **all 5 regulations** applicable (GDPR, CRA, NIS 2, DORA, AI Act), all sole authority sub-domains are covered:

| Sub-Domain | Sole Authority | OmniBank Status | Gap Risk |
|------------|----------------|-----------------|----------|
...
**OmniBank Coverage:** 4/4 sole authority sub-domains covered (100%)  
**OmniBank Gaps:** 0/4 — All sole authority sub-domains covered!

**Mitigation:** No additional mitigation required — all 5 regulations ensure complete coverage with zero gaps.
...
### 5.2 OmniBank-Specific Normative Intensity (All 5 Regulations)
...
| **DORA** | 3.000 | 100.0% | 0.0% | 0.0% | 38 | 29/38 (76.3%) |
| **AI Act** | 2.793 | 82.8% | 17.2% | 0.0% | 29 | 13/38 (34.2%) |
| **OMNIBANK COMBINED** | **2.858** | **88.0%** | **12.0%** | **0.0%** | **150** | **38/38 (100%)** |

**Key Insights for OmniBank:**
- **Maximum regulatory complexity:** All 5 regulations applicable — highest possible compliance burden
- **DORA dominates:** 38 clauses (25.3% of total), 100% Weight 3 (unconditional)
- **100% sub-domain coverage:** No gaps — all 38 sub-domains covered by ≥1 regulation
- **88% unconditional obligations:** 133 of 150 clauses are Weight 3 (mandatory)
- **Financial sector premium:** DORA adds 9 exclusive sub-domains (D-07.2, D-07.3, D-07.4, D-08.3, D-09.3, D-10.1, D-10.2 partial)
...
|---------|------|--------|---------|
| 1.0 | 2026-04-01 | AEGIS Research Team | Initial release - OmniBank Financial Systems case |
