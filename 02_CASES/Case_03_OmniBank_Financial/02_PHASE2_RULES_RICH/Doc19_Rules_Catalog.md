...
| CR-D-02.2-001 | Operate automated patch management with 72-hour SLA for critical vulnerabilities. Include AI model patches, dependency updates, and firmware updates in the patching scope. | CRA-C04, C19; NIS2-C12; DORA-C13 | D-02.2 | 3.000 | P1 | TEST | NATIVE | AG-D-02.1-002, AG-D-04.2-002 | 3 (MUST AVG=3.000) | PR.PS-02 | UNMAPPED_PF (no PF 1.0 analogue for product patch and OTA update management) | MANAGE-2.3 | PARTIAL | PARTIAL | PARTIAL | CRA-C04, C19; NIS2-C12; DORA-C13 → AG-D-02.2-001/-002 → AG-D-02.1-002, AG-D-04.2-002 | CSF/PF/AIRMF inline; ISO 27001 + SSDF → Doc20 §1 aggregate view |
