---
document_id: AEGIS-P2-RICH-LINT-BEFORE-CASE03
title: Lint Report — Sprint 0 Baseline (Case_03 Phase 2 Rich Mode)
phase: 2
version: 1.0
created: 2026-08-07
updated: 2026-08-07
...
# Lint Report — Sprint 0 Baseline (Case_03 Phase 2 Rich Mode)
...
|------|--------|------:|------|
| README.md | NEW | ~150 | `02_CASES/Case_03_OmniBank_Financial/02_PHASE2_RULES_RICH/README.md` |
| PROJECT_STATE.md | NEW | ~120 | `02_CASES/Case_03_OmniBank_Financial/02_PHASE2_RULES_RICH/PROJECT_STATE.md` |
| 08_Obligation_Derivation.md | NEW (placeholder) | ~50 | `02_CASES/Case_03_OmniBank_Financial/02_PHASE2_RULES_RICH/08_Obligation_Derivation.md` |
| 09_Strategic_Tensions_Report.md | NEW (placeholder) | ~50 | `02_CASES/Case_03_OmniBank_Financial/02_PHASE2_RULES_RICH/09_Strategic_Tensions_Report.md` |
| 10_Privacy_Security_Goals.md | NEW (placeholder) | ~50 | `02_CASES/Case_03_OmniBank_Financial/02_PHASE2_RULES_RICH/10_Privacy_Security_Goals.md` |
| 11_Rules_Catalog.md | NEW (placeholder) | ~50 | `02_CASES/Case_03_OmniBank_Financial/02_PHASE2_RULES_RICH/11_Rules_Catalog.md` |
| 12_Rules_Catalog.xlsx | TBD (Sprint 3) | — | `02_CASES/Case_03_OmniBank_Financial/02_PHASE2_RULES_RICH/12_Rules_Catalog.xlsx` |
| scripts/generate_corpus_links.py | NEW (stub) | ~25 | `02_CASES/Case_03_OmniBank_Financial/02_PHASE2_RULES_RICH/scripts/` |
| scripts/filter_ambiguity_cards.py | NEW (stub) | ~25 | `02_CASES/Case_03_OmniBank_Financial/02_PHASE2_RULES_RICH/scripts/` |
| scripts/regenerate_ontology.py | NEW (stub) | ~25 | `02_CASES/Case_03_OmniBank_Financial/02_PHASE2_RULES_RICH/scripts/` |
| **TOTAL** | — | **~545** | — |
...
| 8 | Branch `feature/aegis-p2-case03-rich` created | ✅ PASS |
