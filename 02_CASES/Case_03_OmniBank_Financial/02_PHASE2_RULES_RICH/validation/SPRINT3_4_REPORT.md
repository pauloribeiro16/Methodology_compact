...
title: Sprint 3+4 Combined Report — Catalog Tables + 6 New Columns (Case_03 Phase 2 Rich Mode)
phase: 2
version: 1.0
created: 2026-08-07
updated: 2026-08-07
...
**Why the discrepancy?** D-09.3 (Asset Inventories) is DORA-exclusive and not applicable to OmniBank (per `phase1_ontology.yaml` `subdomains.not_covered`). The legacy summary header is stale from v1.0; the row counts are authoritative.
...
**End of Sprint 3+4 Report — Case_03 Phase 2 Rich Mode**
