...
related_documents: 11_Rules_Catalog.md, 12_Rules_Catalog.xlsx, 04b_Security_Posture.md,
                   09_Strategic_Tensions_Report.md, 06b_DORA_ICT_Risk_Framework.md
note_inputs: >
  Canonical 11_Rules_Catalog.md lives in ../02_PHASE2_RULES/ (with Bloco D extensions
  fields 19-24, tri-maturidade). The Rich copy in this folder preserves the legacy
...
> `csf_norm = |CSF subcats|`; `priv_norm` and `airmf_norm` same convention. `UNMAPPED_CSF` / `UNMAPPED_PRIVACY` / `UNMAPPED_AIRMF` where no natural anchor exists (justification inline).
...
| CR-D-01.2-001 | D-01.2 | GDPR,CRA,DORA | 2.00 (SHOULD) | PR.DS-02 | PR.DS-P2 | UNMAPPED_AIRMF | A.8.24, A.8.20 | — | 1 | 2 | 0 |
...
| CR-D-02.2-001 | D-02.2 | CRA,NIS2,DORA | 3.00 (MUST) | PR.PS-02 | UNMAPPED_PF | UNMAPPED_AIRMF | A.8.8, A.8.19 | RV.2 | 1 | 1 | 0 |
| CR-D-02.3-001 | D-02.3 | CRA | 3.00 (MUST) | ID.RA-08 | ID.IM-P7; GV.PO-P5 | UNMAPPED_AIRMF | A.5.5, A.5.6 | RV.1 | 1 | 2 | 0 |
...
| CR-D-03.2-001 | D-03.2 | CRA,NIS2,DORA | 2.00 (SHOULD) | PR.AA-03 | UNMAPPED_PF | UNMAPPED_AIRMF | A.8.5, A.8.2 | — | 1 | 1 | 0 |
| CR-D-03.3-001 | D-03.3 | GDPR,NIS2,DORA | 3.00 (MUST) | PR.AA-05,PR.AA-01 | CT.PO-P1 | UNMAPPED_AIRMF | A.5.15, A.5.18, A.8.3 | — | 2 | 3 | 0 |
| CR-D-03.4-001 | D-03.4 | CRA | 3.00 (MUST) | PR.PS-01 | CT.DP-P4,CT.PO-P4 | UNMAPPED_AIRMF | A.8.9 | PW.9 | 1 | 2 | 0 |
| CR-D-04.1-001 | D-04.1 | CRA,NIS2,DORA | 3.00 (MUST) | DE.AE-02,DE.CM-01,DE.CM-09 | CM.AW-P7 | UNMAPPED_AIRMF | A.5.25, A.8.16 | RV.1 | 3 | 2 | 0 |
| CR-D-04.2-001 | D-04.2 | GDPR,CRA,NIS2,DORA | 2.00 (SHOULD) | RS.MI-01,RS.MI-02 | PR.PO-P7,CT.DM-P10 | UNMAPPED_AIRMF | A.5.26, A.5.29 | — | 2 | 4 | 0 |
...
| CR-D-04.4-001 | D-04.4 | GDPR,NIS2,DORA | 2.00 (SHOULD) | RC.RP-01,RC.RP-03,RC.RP-05 | UNMAPPED_PF | UNMAPPED_AIRMF | A.8.13, A.8.14, A.5.30 | — | 3 | 3 | 0 |
...
| CR-D-06.1-001 | D-06.1 | GDPR,NIS2,DORA | 3.00 (MUST) | GV.SC-04; GV.SC-07; ID.RA-10 | ID.IM-P2 | UNMAPPED_AIRMF | A.5.19, A.5.20, A.5.22 | PW.4 | 3 | 2 | 0 |
| CR-D-06.2-001 | D-06.2 | CRA | 3.00 (MUST) | GV.SC-09 | ID.IM-P7 | UNMAPPED_AIRMF | A.5.21, A.5.9 | PS.3 | 1 | 1 | 0 |
| CR-D-06.3-001 | D-06.3 | GDPR,NIS2,DORA | 3.00 (MUST) | GV.SC-05; GV.SC-06 | GV.PO-P5 | UNMAPPED_AIRMF | A.5.20, A.5.31 | — | 2 | 3 | 0 |
| CR-D-06.4-001 | D-06.4 | NIS2,DORA | 3.00 (MUST) | DE.CM-06,PR.IR-01 | UNMAPPED_PF | UNMAPPED_AIRMF | A.8.22, A.8.21 | — | 2 | 1 | 0 |
| CR-D-07.1-001 | D-07.1 | GDPR,CRA | 2.00 (SHOULD) | PR.PS-06,ID.RA-01 | GV.PO-P2,CT.PO-P4,CT.DP-P2,CT.DP-P5 | UNMAPPED_AIRMF | A.8.25, A.8.27, A.5.8 | PO.1, PW.1 | 2 | 4 | 0 |
| CR-D-07.2-001 | D-07.2 | NIS2,DORA | 3.00 (MUST) | PR.PS-06 | UNMAPPED_PF | UNMAPPED_AIRMF | A.8.28, A.8.26 | PW.5 | 1 | 1 | 0 |
| CR-D-07.3-001 | D-07.3 | NIS2,DORA | 3.00 (MUST) | PR.PS-06,PR.PS-02 | UNMAPPED_PF | UNMAPPED_AIRMF | A.8.4, A.8.31, A.8.29 | PO.3, PW.6 | 2 | 1 | 0 |
| CR-D-07.4-001 | D-07.4 | NIS2,DORA | 3.00 (MUST) | ID.RA-07 | ID.RA-P3 | UNMAPPED_AIRMF | A.8.32, A.8.19 | RV.3 | 1 | 1 | 0 |
...
| CR-D-08.3-001 | D-08.3 | NIS2,DORA | 3.00 (MUST) | GV.RR-01,PR.AT-02 | UNMAPPED_PF | UNMAPPED_AIRMF | A.5.4, A.5.35 | PO.2 | 2 | 1 | 0 |
...
| CR-D-09.3-001 | D-09.3 | NIS2,DORA | 3.00 (MUST) | ID.AM-01,ID.AM-02,ID.AM-07 | ID.IM-P1,ID.IM-P4,ID.IM-P6,ID.IM-P8 | UNMAPPED_AIRMF | A.5.9, A.7.10 | — | 3 | 4 | 0 |
...
| CR-D-10.3-001 | D-10.3 | GDPR,CRA,NIS2,DORA,AI_Act | 3.00 (MUST) | ID.IM-01,ID.IM-02,ID.IM-03 | UNMAPPED_PF | MEASURE-1.1,MEASURE-2.1,MEASURE-2.3,MEASURE-2.7,MAP-3.3 | A.5.35, A.5.36, A.8.29 | PW.7, PW.8 | 3 | 1 | 5 |
...
> §2.5 includes a **special section on T-001..T-004 cross-reference + DORA Art. 5-6 ICT governance + DORA Art. 9 ICT risk management framework** (Case_03-specific — these DORA articles are the defining characteristics of Case_03 per `06b_DORA_ICT_Risk_Framework.md`).
...
| Privacy FW | `GV-P.RR-P1`, `GV-P.RR-P2`, `GV-P.RR-P4` | Liderança responsável; papéis workforce; recursos adequados (DPO per Art. 37) | ✅ CR-D-09.1-001, CR-D-09.4-001 (DPO designation per `04d_Org_Roles_RACI.md`) |
| AI RMF | `GOVERN-2.1`, `GOVERN-2.2`, `GOVERN-3.1` | Papéis, responsabilidades documentados; treino AI-specific; decisão informada por equipa diversa | ✅ CR-D-03.1-001 (AI identity governance), CR-D-08.2-001 (AI-specific training), CR-D-09.1-001 (AI Governance Lead per `04d_Org_Roles_RACI.md`) |
...
> **T-005 (DORA TLPT triennial vs ISO 27001 annual — MEDIUM, structural)** is the only tension NOT in T-001..T-004 set and is tracked separately in `07_Structured_Compliance_Matrix.md` §5.5. Resolved by **cycle orchestration**: DORA Art. 26 TLPT every 3 years (most stringent, ECB-supervised significance) + ISO 27001 annual surveillance in between (with TLPT-scope mini-tests in year 2) + AI Act Art. 43 conformity at each major release.
...
- rule_id: CR-D-07.1-001
  ...
  airmf_subcategories: [UNMAPPED_AIRMF]
  mapping_rationale: no AI-C* in source — AVG(NI)=2.667 below MUST threshold → SHOULD; **T-004 RESOLVED** — Follow CRA higher bar (NI=3 MUST); industry secure software development framework (SP 800-218) + industry software assurance maturity model Level 3 + architecture review board; frameworks are mapping targets, never derivation sources (AEGIS invariant)
```
...
> For Case_03 (MAX), Track B applies: **RIGOROUS → tgt 4/4 (Optimized)**, **STANDARD → tgt 3/4 (Managed)**. 31 RIGOROUS + 7 STANDARD = 38 sub-domains (per `07b_Proportionality_Profile.md` §3).
...
### §4.5 — Tabela de avaliação por-Function Case_03 (15 rows: 6 CSF + 5 Privacy + 4 AI RMF)

> `cur_tier` from Doc 11 column 13 (Maturity Score) aggregated per Function; `tgt_tier` from Track B tier (`07b_Proportionality_Profile.md` §3) and posture assessment (`04b_Security_Posture.md` §3). **Case_03 MAX profile**: 31 RIGOROUS sub-domains → tgt 4/4; 7 STANDARD sub-domains → tgt 3/4.

| # | Framework | Function | cur_tier | tgt_tier | Justification |
|---|-----------|----------|---------:|---------:|---------------|
| 1 | CSF 2.0 | **GV** Govern | 3 | 4 | 5-policy ISMS architecture (ISO 27001 + DORA Art. 5 + AI Act + GDPR + NIS 2) at 3/4; target 4 with continuous-improvement artefacts (Doc 04 §9; Doc 04b §D-09; `04d_Org_Roles_RACI.md`) |
| 2 | CSF 2.0 | **ID** Identify | 3 | 4 | DORA Art. 8 ICT inventory + GDPR RoPA + AI model registry at 3/4; target 4 with continuous asset discovery + automated reconciliation |
| 3 | CSF 2.0 | **PR** Protect | 3 | 4 | Cryptographic material custody (D-01.1 STANDARD 2→3 cur partial), IAM (D-03.1), AI RMF MAP-3.5; target 4 with full PAM automation (JIT + zero-standing-privilege) |
| 4 | CSF 2.0 | **DE** Detect | 3 | 4 | 24/7 SOC + centralized audit-log + AI-driven detection (D-04.1, D-10.1); target 4 with AI post-market monitoring complete + centralized audit-log 1y hot retention (Doc 04b §D-10.1 gap closed) |
| 5 | CSF 2.0 | **RS** Respond | 3 | 4 | Max-SLA 4h DORA routing (T-001 RESOLVED, D-04.3 RIGOROUS); target 4 with automation and external audit (Doc 04b §D-04) |
| 6 | CSF 2.0 | **RC** Recover | 3 | 4 | RTO 4h, RPO 15min (D-04.4); cryptographic sharding (D-10.2, T-002 RESOLVED); target 4 with hash-chained WORM + cold standby 1 active |
| 7 | Privacy FW | **ID-P** Identify | 3 | 4 | RoPA complete, IPSARA unified with FRIA (D-09.2 RIGOROUS); target 4 with automated data discovery (OneTrust + AI inventory) |
| 8 | Privacy FW | **GV-P** Govern | 3 | 4 | ISMS with GDPR Annex + DPO designation (D-09.1); target 4 with privacy-by-design automatizado (D-07.1 RIGOROUS) |
| 9 | Privacy FW | **CT-P** Control | 3 | 4 | Cryptographic sharding (D-05.3 STANDARD cur 2 — T-002 RESOLVED in deployment); tiered retention (D-05.2 STANDARD cur 3 — BaFin/ECB 5-10y); biometric ephemeral deletion (D-05.1 STANDARD cur 2); target 4 with key destruction automation |
| 10 | Privacy FW | **CM-P** Communicate | 3 | 3 | Privacy notice + DSAR + 5-reg breach notification workflow (D-04.3 RIGOROUS); target 3 (CM-P fully met by 04b §D-09; higher tier not required for MAX proportionality) |
| 11 | Privacy FW | **PR-P** Protect | 3 | 4 | Cryptographic material custody + mutual transport-layer security + IAM (D-01.x, D-03.x); target 4 with PAM automation + AI-specific role-based competence |
| 12 | AI RMF | **GOVERN** | 3 | 4 | 5-policy architecture + AI Governance Lead (D-09.1 RIGOROUS); target 4 with continuous AI risk review + AI Act Art. 9 lifecycle |
| 13 | AI RMF | **MAP** | 3 | 4 | IPSARA unified DPIA + FRIA (D-09.2); AI use cases mapped; target 4 with MAP-5.1/5.2 fully documented (currently MAP-5.2 unused per AI RMF frozen list §"Unused") |
| 14 | AI RMF | **MEASURE** | 2 | 4 | AI Act conformity assessment IN PROGRESS (D-10.3 RIGOROUS, AVG 2.857); post-market monitoring partial (Doc 04b §D-10.1 gap); TLPT triennial cycle (T-005); target 4 by Q4 2026 |
| 15 | AI RMF | **MANAGE** | 3 | 4 | Incident response playbooks (D-04.x, D-10.x); target 4 with automated prioritization + 4h RTS clock automation |
...
### §4.6 — Heatmap formula (Case_03 — MAX tier, FN-03 fix applied)

> `gap_worst = MAX(gap_csf, gap_priv, gap_airmf)` with **N/A exclusion rule** (FN-03 fix from Case_02 applied — use as model):
> When a framework is N/A for a control (e.g. AI RMF for a CR without AI-C*; PF for a control touching only non-personal-data assets), it is **excluded from the MAX, not treated as gap 0**. The reasoning: a zero in a non-applicable framework would mask a real gap in the applicable framework and would falsely "green" the heatmap. MAX-of-applicable is the conservative (worst-case) aggregation appropriate for a MAX-tier bank where any single-framework gap is operationally significant.
> **Examples:**
> - `CR-D-06.4-001` (NIS 2 + DORA Sole Authority, third-party boundary): gap_csf=1, gap_priv=0 (N/A — NIS 2/DORA-only sub-domain not covered by GDPR SR mapping), gap_airmf=0 (N/A — no AI-C*); `gap_worst = MAX(1, 0_excl, 0_excl) = 1`.
> - `CR-D-09.1-001` (5-reg ISMS, RIGOROUS): gap_csf=1, gap_priv=1, gap_airmf=1; `gap_worst = MAX(1, 1, 1) = 1`.
> - `CR-D-10.1-001` (continuous monitoring + AI post-market, RIGOROUS): gap_csf=1, gap_priv=1, gap_airmf=1; `gap_worst = 1` (worst-case, drives the heatmap to ORANGE if any framework has a gap ≥ 2).
> - `CR-D-05.4-001` (data portability, UNMAPPED_CSF): gap_csf=0 (UNMAPPED — N/A), gap_priv=1, gap_airmf=0 (N/A — no AI-C*); `gap_worst = MAX(0_excl, 1, 0_excl) = 1`.

This rule is applied to every row in §5.1.
...
> `cur_csf` = Doc 11 column 13 (Maturity Score) per sub-domain from `07b_Proportionality_Profile.md` §11; `tgt_csf` = Track B target per `07b_Proportionality_Profile.md` §3 (RIGOROUS → 4, STANDARD → 3).
...
| rule_id | sub_domain | cur_csf | tgt_csf | cur_priv | tgt_priv | cur_airmf | tgt_airmf | gap_csf | gap_priv | gap_airmf | gap_worst |
|---------|-----------|--------:|--------:|---------:|---------:|----------:|----------:|--------:|---------:|----------:|----------:|

| CR-D-01.1-001 | D-01.1 | 2 | 4 | 2 | 4 | 2 | 4 | 2 | 2 | 2 | 2 |
| CR-D-01.2-001 | D-01.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-01.3-001 | D-01.3 | 2 | 4 | 2 | 4 | 2 | 4 | 2 | 2 | 2 | 2 |
| CR-D-01.4-001 | D-01.4 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 |
| CR-D-02.1-001 | D-02.1 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 |
| CR-D-02.2-001 | D-02.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-02.3-001 | D-02.3 | 2 | 3 | 2 | 3 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-02.4-001 | D-02.4 | 1 | 4 | 1 | 4 | 1 | 4 | 3 | 3 | 3 | 3 |
| CR-D-03.1-001 | D-03.1 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 |
| CR-D-03.2-001 | D-03.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-03.3-001 | D-03.3 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-03.4-001 | D-03.4 | 2 | 3 | 2 | 3 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-04.1-001 | D-04.1 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-04.2-001 | D-04.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-04.3-001 | D-04.3 | 2 | 4 | 2 | 4 | 2 | 4 | 2 | 2 | 2 | 2 |
| CR-D-04.4-001 | D-04.4 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-05.1-001 | D-05.1 | 2 | 3 | 2 | 3 | 2 | 3 | 1 | 1 | 1 | 1 |
| CR-D-05.2-001 | D-05.2 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 |
| CR-D-05.3-001 | D-05.3 | 2 | 4 | 2 | 4 | N/A | N/A | 2 | 2 | N/A | 2 |
| CR-D-05.4-001 | D-05.4 | 2 | 3 | 2 | 3 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-06.1-001 | D-06.1 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-06.2-001 | D-06.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-06.3-001 | D-06.3 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-06.4-001 | D-06.4 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-07.1-001 | D-07.1 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-07.2-001 | D-07.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-07.3-001 | D-07.3 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-07.4-001 | D-07.4 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-08.1-001 | D-08.1 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-08.2-001 | D-08.2 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 |
| CR-D-08.3-001 | D-08.3 | 2 | 4 | 2 | 4 | N/A | N/A | 2 | 2 | N/A | 2 |
| CR-D-09.1-001 | D-09.1 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 |
| CR-D-09.2-001 | D-09.2 | 2 | 4 | 2 | 4 | 2 | 4 | 2 | 2 | 2 | 2 |
| CR-D-09.3-001 | D-09.3 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| CR-D-09.4-001 | D-09.4 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 |
| CR-D-10.1-001 | D-10.1 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 |
| CR-D-10.2-001 | D-10.2 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 |
| CR-D-10.3-001 | D-10.3 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 |
| BPR-D-01.1-001 | D-01.1 | 2 | 4 | 2 | 4 | N/A | N/A | 2 | 2 | N/A | 2 |
| BPR-D-01.2-001 | D-01.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-01.3-001 | D-01.3 | 2 | 4 | 2 | 4 | N/A | N/A | 2 | 2 | N/A | 2 |
| BPR-D-01.4-001 | D-01.4 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-02.1-001 | D-02.1 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-02.2-001 | D-06.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-02.3-001 | D-02.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-02.4-001 | D-02.4 | 1 | 4 | 1 | 4 | N/A | N/A | 3 | 3 | N/A | 3 |
| BPR-D-03.1-001 | D-03.1 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-03.2-001 | D-03.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-03.3-001 | D-03.3 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-03.4-001 | D-03.4 | 2 | 3 | 2 | 3 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-04.1-001 | D-04.1 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-04.2-001 | D-04.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-04.3-001 | D-04.3 | 2 | 4 | 2 | 4 | N/A | N/A | 2 | 2 | N/A | 2 |
| BPR-D-04.4-001 | D-04.4 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-05.1-001 | D-05.1 | 2 | 3 | 2 | 3 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-05.3-001 | D-05.3 | 2 | 4 | 2 | 4 | N/A | N/A | 2 | 2 | N/A | 2 |
| BPR-D-05.4-001 | D-05.4 | 2 | 3 | 2 | 3 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-06.1-001 | D-06.1 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-06.3-001 | D-06.3 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-06.4-001 | D-06.4 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-07.1-001 | D-07.1 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-07.2-001 | D-07.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-07.3-001 | D-07.3 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-07.4-001 | D-07.4 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-08.1-001 | D-08.1 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-08.2-001 | D-08.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-08.3-001 | D-08.3 | 2 | 4 | 2 | 4 | N/A | N/A | 2 | 2 | N/A | 2 |
| BPR-D-09.1-001 | D-09.1 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-09.2-001 | D-09.2 | 2 | 4 | 2 | 4 | N/A | N/A | 2 | 2 | N/A | 2 |
| BPR-D-09.3-001 | D-09.2 | 2 | 4 | 2 | 4 | 2 | 4 | 2 | 2 | 2 | 2 |
| BPR-D-09.4-001 | D-09.1 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-10.1-001 | D-10.1 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-10.2-001 | D-10.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-10.3-001 | D-10.3 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 |
| BPR-D-12.1-001 | D-02.4 | 1 | 4 | 1 | 4 | 1 | 4 | 3 | 3 | 3 | 3 |
| BPR-D-12.2-001 | D-10.1 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 |
| BPR-D-12.3-001 | D-08.2 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 |
| BPR-D-12.4-001 | D-02.1 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 |
...
|---|-----------|----------|---------:|---------:|----:|-----------------------|---------------|
| 1 | CSF 2.0 | GV | 2 | 4 | 2 | D-09.1, D-09.2, D-09.3, D-09.4 | D-09.2 IPSARA cur 2 (T-003 unified assessment in deployment) caps GV |
| 2 | CSF 2.0 | ID | 1 | 4 | 3 | D-02.1, D-02.2, D-02.3, D-02.4, D-09.3 | D-02.4 TLPT cur 1 (RIGOROUS, T-005 cycle orchestration in deployment) caps ID |
| 3 | CSF 2.0 | PR | 2 | 4 | 2 | D-01.x, D-03.x, D-05.x, D-07.x | D-01.1 cryptographic material custody cur 2 + D-01.3 key management cur 2 cap PR (RIGOROUS, Doc 04b §D-01 gap) |
| 4 | CSF 2.0 | DE | 3 | 4 | 1 | D-04.1, D-04.2, D-04.3, D-04.4 | D-04.3 cur 2 (RIGOROUS, multi-reg notification in deployment) — wait, DE includes D-04.1/D-04.2/D-04.3/D-04.4, where D-04.3 cur 2 → DE cur = 2; but DE primary is D-04.1/D-10.1. Recompute: DE maps to D-04.1, D-04.2, D-04.3, D-04.4 + D-10.1 — MAX = 2 (D-04.3) |
| 5 | CSF 2.0 | RS | 2 | 4 | 2 | D-04.x | D-04.3 cur 2 anchors RS |
| 6 | CSF 2.0 | RC | 3 | 4 | 1 | D-04.4, D-10.2 | D-04.4 cur 3, D-10.2 cur 3 |
| 7 | Privacy FW | ID-P | 2 | 4 | 2 | D-09.2, D-09.4 | D-09.2 cur 2 (IPSARA in deployment) caps ID-P |
| 8 | Privacy FW | GV-P | 2 | 4 | 2 | D-09.1, D-09.2, D-09.4 | D-09.1 cur 3, D-09.2 cur 2 caps GV-P |
| 9 | Privacy FW | CT-P | 2 | 4 | 2 | D-05.1, D-05.2, D-05.3, D-05.4 | D-05.1 cur 2 + D-05.3 cur 2 + D-05.4 cur 2 cap CT-P (T-002 cryptographic sharding in deployment) |
| 10 | Privacy FW | CM-P | 3 | 4 | 1 | D-09.1, D-09.4 | Privacy notice + DSAR + 5-reg breach notification; gap from D-09.1 IPSARA-derived |
| 11 | Privacy FW | PR-P | 2 | 4 | 2 | D-01.x, D-03.x, D-05.x | D-01.1 cryptographic material custody cur 2 caps PR-P |
| 12 | AI RMF | GOVERN | 2 | 4 | 2 | D-09.1, D-09.2, D-08.2, D-03.1, D-04.3 | D-04.3 cur 2 (max-SLA routing AI Act) anchors GOVERN |
| 13 | AI RMF | MAP | 2 | 4 | 2 | D-09.1, D-09.2, D-05.1, D-05.2 | D-09.2 cur 2 (IPSARA, MAP-5 partial) caps MAP |
| 14 | AI RMF | MEASURE | 1 | 4 | 3 | D-10.1, D-10.2, D-10.3, D-02.1, D-02.4, D-04.1, D-09.2, D-05.1, D-05.2 | **Largest gap.** D-02.4 cur 1 (TLPT adversarial robustness + AI bias testing INCOMPLETE per Doc 04b §4 #2) |
| 15 | AI RMF | MANAGE | 2 | 4 | 2 | D-04.2, D-04.3, D-09.2, D-10.1 | D-04.3 cur 2 anchors MANAGE |
...
> Five axes: (a) framework subcategories not covered by any Case_03 CR/BPR; (b) sub-domains with low target maturity; (c) frozen-list integrity findings (deferred); (d) NI distribution analysis (DF9); (e) tension cross-reference.
...
| `GV.OC-02` (Stakeholder needs understood) | gap-acceptable | Stakeholder management lives in `05_Regulatory_Applicability.md` + `04d_Org_Roles_RACI.md`; CSF anchor used by D-09.1 |
...
> - Specialised de-identification (`UNMAPPED_PRIVACY (CT.DP family has -P1..-P5 only)` range -P6..-P9) — no direct GDPR clause
...
> Per the §4.6 rule, every active sub-domain in Case_03 has tgt ≥ 3 (Track B floor: STANDARD → tgt 3, RIGOROUS → tgt 4). **Zero sub-domains have tgt < 3** in Case_03 (Track B floor enforced; MAX scale excludes DEFERRED per `07b_Proportionality_Profile.md` §5.2).
...
3. **1 non-existent PF ID (UNMAPPED)** — replaced in §6.2: the `CT.DP` family beyond `-P5` is replaced with `UNMAPPED_PRIVACY (CT.DP family has -P1..-P5 only)` — descriptive reference only (the range `-P6..-P9` describes special de-identification techniques not anchored by a Case_03 CR).
...
> Per `09_Strategic_Tensions_Report.md` (Case_03: 4 tensions; this section cross-references all 4 for the Govern view §2.5 — T-001, T-002, T-003, T-004 + T-005 from Sprint 1).
...
> **No resolution here** — resolutions live in `09_Strategic_Tensions_Report.md` §4 and `11_Rules_Catalog.md` §8. This section is a **pointer** for the framework mapping view. **DORA-specific note**: T-001 explicitly references DORA Art. 19 + RTS 2025/301 Art. 6 (4h post-classification); T-002 references DORA Art. 11 immutable logs; T-005 references DORA Art. 26 TLPT. DORA is the **defining characteristic** of Case_03 per `06b_DORA_ICT_Risk_Framework.md`.
...
| CR-D-01.2-001 | CR | 2.00 (SHOULD) | GDPR,CRA,DORA | D-01.2 | PR.DS-02 | PR.DS-P2 | UNMAPPED_AIRMF |
...
| CR-D-02.2-001 | CR | 3.00 (MUST) | CRA,NIS2,DORA | D-02.2 | PR.PS-02 | UNMAPPED_PF | UNMAPPED_AIRMF |
| CR-D-02.3-001 | CR | 3.00 (MUST) | CRA | D-02.3 | ID.RA-08 | ID.IM-P7,GV.PO-P5 | UNMAPPED_AIRMF |
...
| CR-D-03.2-001 | CR | 2.00 (SHOULD) | CRA,NIS2,DORA | D-03.2 | PR.AA-03 | UNMAPPED_PF | UNMAPPED_AIRMF |
| CR-D-03.3-001 | CR | 3.00 (MUST) | GDPR,NIS2,DORA | D-03.3 | PR.AA-05,PR.AA-01 | CT.PO-P1 | UNMAPPED_AIRMF |
| CR-D-03.4-001 | CR | 3.00 (MUST) | CRA | D-03.4 | PR.PS-01 | CT.DP-P4,CT.PO-P4 | UNMAPPED_AIRMF |
| CR-D-04.1-001 | CR | 3.00 (MUST) | CRA,NIS2,DORA | D-04.1 | DE.AE-02,DE.CM-01,DE.CM-09 | CM.AW-P7 | UNMAPPED_AIRMF |
| CR-D-04.2-001 | CR | 2.00 (SHOULD) | GDPR,CRA,NIS2,DORA | D-04.2 | RS.MI-01,RS.MI-02 | PR.PO-P7,CT.DM-P10 | UNMAPPED_AIRMF |
...
| CR-D-04.4-001 | CR | 2.00 (SHOULD) | GDPR,NIS2,DORA | D-04.4 | RC.RP-01,RC.RP-03,RC.RP-05 | UNMAPPED_PF | UNMAPPED_AIRMF |
...
| CR-D-06.1-001 | CR | 3.00 (MUST) | GDPR,NIS2,DORA | D-06.1 | GV.SC-04; GV.SC-07; ID.RA-10 | ID.IM-P2 | UNMAPPED_AIRMF |
| CR-D-06.2-001 | CR | 3.00 (MUST) | CRA | D-06.2 | GV.SC-09 | ID.IM-P7 | UNMAPPED_AIRMF |
| CR-D-06.3-001 | CR | 3.00 (MUST) | GDPR,NIS2,DORA | D-06.3 | GV.SC-05; GV.SC-06 | GV.PO-P5 | UNMAPPED_AIRMF |
| CR-D-06.4-001 | CR | 3.00 (MUST) | NIS2,DORA | D-06.4 | DE.CM-06,PR.IR-01 | UNMAPPED_PF | UNMAPPED_AIRMF |
| CR-D-07.1-001 | CR | 2.00 (SHOULD) | GDPR,CRA | D-07.1 | PR.PS-06,ID.RA-01 | GV.PO-P2,CT.PO-P4,CT.DP-P2,CT.DP-P5 | UNMAPPED_AIRMF |
| CR-D-07.2-001 | CR | 3.00 (MUST) | NIS2,DORA | D-07.2 | PR.PS-06 | UNMAPPED_PF | UNMAPPED_AIRMF |
| CR-D-07.3-001 | CR | 3.00 (MUST) | NIS2,DORA | D-07.3 | PR.PS-06,PR.PS-02 | UNMAPPED_PF | UNMAPPED_AIRMF |
| CR-D-07.4-001 | CR | 3.00 (MUST) | NIS2,DORA | D-07.4 | ID.RA-07 | ID.RA-P3 | UNMAPPED_AIRMF |
...
| CR-D-08.3-001 | CR | 3.00 (MUST) | NIS2,DORA | D-08.3 | GV.RR-01,PR.AT-02 | UNMAPPED_PF | UNMAPPED_AIRMF |
...
| CR-D-09.3-001 | CR | 3.00 (MUST) | NIS2,DORA | D-09.3 | ID.AM-01,ID.AM-02,ID.AM-07 | ID.IM-P1,ID.IM-P4,ID.IM-P6,ID.IM-P8 | UNMAPPED_AIRMF |
...
| CR-D-10.3-001 | CR | 3.00 (MUST) | GDPR,CRA,NIS2,DORA,AI_Act | D-10.3 | ID.IM-01,ID.IM-02,ID.IM-03 | UNMAPPED_PF | MEASURE-1.1,MEASURE-2.1,MEASURE-2.3,MEASURE-2.7,MAP-3.3 |
| BPR-D-01.1-001 | BPR | 2.00 (SHOULD) | — | D-01.1 | PR.DS-01,PR.DS-10 | PR.DS-P1,CT.DP-P2 | UNMAPPED_AIRMF |
| BPR-D-01.2-001 | BPR | 2.00 (SHOULD) | — | D-01.2 | PR.DS-02 | PR.DS-P2 | UNMAPPED_AIRMF |
| BPR-D-01.3-001 | BPR | 2.00 (SHOULD) | — | D-01.3 | PR.DS-01 | PR.DS-P1,CT.DP-P2 | UNMAPPED_AIRMF |
| BPR-D-01.4-001 | BPR | 2.00 (SHOULD) | — | D-01.4 | PR.DS-01,PR.DS-02 | PR.DS-P1,CT.DM-P1,CT.DM-P3 | UNMAPPED_AIRMF |
| BPR-D-02.1-001 | BPR | 2.00 (SHOULD) | — | D-02.1 | ID.RA-01,DE.CM-01 | ID.RA-P3,ID.RA-P5 | UNMAPPED_AIRMF |
| BPR-D-02.2-001 | BPR | 2.00 (SHOULD) | — | D-06.2 | GV.SC-09 | ID.IM-P7 | UNMAPPED_AIRMF |
| BPR-D-02.3-001 | BPR | 2.00 (SHOULD) | — | D-02.2 | PR.PS-02 | UNMAPPED_PF | UNMAPPED_AIRMF |
| BPR-D-02.4-001 | BPR | 2.00 (SHOULD) | — | D-02.4 | ID.IM-02,ID.RA-03 | ID.RA-P3,ID.RA-P4,ID.RA-P5 | UNMAPPED_AIRMF |
| BPR-D-03.1-001 | BPR | 2.00 (SHOULD) | — | D-03.1 | PR.AA-01,PR.AA-05 | CT.PO-P1 | UNMAPPED_AIRMF |
| BPR-D-03.2-001 | BPR | 2.00 (SHOULD) | — | D-03.2 | PR.AA-03 | UNMAPPED_PF | UNMAPPED_AIRMF |
| BPR-D-03.3-001 | BPR | 2.00 (SHOULD) | — | D-03.3 | PR.AA-05,PR.AA-01 | CT.PO-P1 | UNMAPPED_AIRMF |
| BPR-D-03.4-001 | BPR | 2.00 (SHOULD) | — | D-03.4 | PR.PS-01 | CT.DP-P4,CT.PO-P4 | UNMAPPED_AIRMF |
| BPR-D-04.1-001 | BPR | 2.00 (SHOULD) | — | D-04.1 | DE.AE-02,DE.CM-01 | CM.AW-P7 | UNMAPPED_AIRMF |
| BPR-D-04.2-001 | BPR | 2.00 (SHOULD) | — | D-04.2 | RS.MI-01,RS.MI-02 | PR.PO-P7,CT.DM-P10 | UNMAPPED_AIRMF |
| BPR-D-04.3-001 | BPR | 2.00 (SHOULD) | — | D-04.3 | RS.CO-02,RS.CO-03 | CM.AW-P7,CM.PO-P2,CM.PO-P1,GV.PO-P5 | UNMAPPED_AIRMF |
| BPR-D-04.4-001 | BPR | 2.00 (SHOULD) | — | D-04.4 | RC.RP-01,RC.RP-03,RC.RP-05 | UNMAPPED_PF | UNMAPPED_AIRMF |
| BPR-D-05.1-001 | BPR | 2.00 (SHOULD) | — | D-05.1 | PR.DS-10,ID.AM-03 | CT.PO-P4,CT.DP-P4,ID.RA-P3 | UNMAPPED_AIRMF |
| BPR-D-05.3-001 | BPR | 2.00 (SHOULD) | — | D-05.3 | PR.DS-10 | CT.DM-P4,CT.DM-P5 | UNMAPPED_AIRMF |
| BPR-D-05.4-001 | BPR | 2.00 (SHOULD) | — | D-05.4 | UNMAPPED_CSF | CT.DM-P1,CT.DM-P6 | UNMAPPED_AIRMF |
| BPR-D-06.1-001 | BPR | 2.00 (SHOULD) | — | D-06.1 | GV.SC-04; GV.SC-07 | ID.IM-P2 | UNMAPPED_AIRMF |
| BPR-D-06.3-001 | BPR | 2.00 (SHOULD) | — | D-06.3 | GV.SC-05; GV.SC-06 | GV.PO-P5 | UNMAPPED_AIRMF |
| BPR-D-06.4-001 | BPR | 2.00 (SHOULD) | — | D-06.4 | DE.CM-06,PR.IR-01 | UNMAPPED_PF | UNMAPPED_AIRMF |
| BPR-D-07.1-001 | BPR | 2.00 (SHOULD) | — | D-07.1 | PR.PS-06,ID.RA-01 | GV.PO-P2,CT.PO-P4,CT.DP-P2,CT.DP-P5 | UNMAPPED_AIRMF |
| BPR-D-07.2-001 | BPR | 2.00 (SHOULD) | — | D-07.2 | PR.PS-06 | UNMAPPED_PF | UNMAPPED_AIRMF |
| BPR-D-07.3-001 | BPR | 2.00 (SHOULD) | — | D-07.3 | PR.PS-06,PR.PS-02 | UNMAPPED_PF | UNMAPPED_AIRMF |
| BPR-D-07.4-001 | BPR | 2.00 (SHOULD) | — | D-07.4 | ID.RA-07 | ID.RA-P3 | UNMAPPED_AIRMF |
| BPR-D-08.1-001 | BPR | 2.00 (SHOULD) | — | D-08.1 | PR.AT-01 | GV.AT-P1,GV.AT-P2 | UNMAPPED_AIRMF |
| BPR-D-08.2-001 | BPR | 2.00 (SHOULD) | — | D-08.2 | PR.AT-02 | GV.AT-P1,GV.AT-P2 | UNMAPPED_AIRMF |
| BPR-D-08.3-001 | BPR | 2.00 (SHOULD) | — | D-08.3 | GV.RR-01,PR.AT-02 | UNMAPPED_PF | UNMAPPED_AIRMF |
| BPR-D-09.1-001 | BPR | 2.00 (SHOULD) | — | D-09.1 | GV.PO-01,GV.PO-02 | GV.PO-P1,GV.PO-P5 | UNMAPPED_AIRMF |
| BPR-D-09.2-001 | BPR | 2.00 (SHOULD) | — | D-09.2 | ID.RA-04,ID.RA-05,GV.RM-06 | ID.RA-P3,ID.RA-P4,ID.RA-P5 | UNMAPPED_AIRMF |
...
| BPR-D-10.1-001 | BPR | 2.00 (SHOULD) | — | D-10.1 | DE.CM-01,DE.CM-09,DE.AE-02 | CM.AW-P7 | UNMAPPED_AIRMF |
| BPR-D-10.2-001 | BPR | 2.00 (SHOULD) | — | D-10.2 | PR.PS-04,DE.AE-03,RS.AN-06 | CT.DM-P9 | UNMAPPED_AIRMF |
| BPR-D-10.3-001 | BPR | 2.00 (SHOULD) | — | D-10.3 | ID.IM-01,ID.IM-02,ID.IM-03 | UNMAPPED_PF | UNMAPPED_AIRMF |
...
### V4 — Heatmap de Maturidade (Tri-axis MAX worst)
...
|------------|--------:|--------:|---------:|---------:|----------:|----------:|--------:|---------:|----------:|--------:|----------:|:------|
| D-02.4 | 1 | 4 | 1 | 4 | 1 | 4 | 3 | 3 | 3 | 3 | 3 | RED |
| D-01.1 | 2 | 4 | 2 | 4 | 2 | 4 | 2 | 2 | 2 | 2 | 2 | ORANGE |
| D-01.3 | 2 | 4 | 2 | 4 | 2 | 4 | 2 | 2 | 2 | 2 | 2 | ORANGE |
| D-04.3 | 2 | 4 | 2 | 4 | 2 | 4 | 2 | 2 | 2 | 2 | 2 | ORANGE |
| D-05.3 | 2 | 4 | 2 | 4 | N/A | N/A | 2 | 2 | N/A | 2 | 2 | ORANGE |
| D-08.3 | 2 | 4 | 2 | 4 | N/A | N/A | 2 | 2 | N/A | 2 | 2 | ORANGE |
| D-09.2 | 2 | 4 | 2 | 4 | 2 | 4 | 2 | 2 | 2 | 2 | 2 | ORANGE |
| D-01.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-01.4 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 | 1 | YELLOW |
| D-02.1 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 | 1 | YELLOW |
| D-02.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-02.3 | 2 | 3 | 2 | 3 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-03.1 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 | 1 | YELLOW |
| D-03.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-03.3 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-03.4 | 2 | 3 | 2 | 3 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-04.1 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-04.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-04.4 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-05.1 | 2 | 3 | 2 | 3 | 2 | 3 | 1 | 1 | 1 | 1 | 1 | YELLOW |
| D-05.2 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 | 1 | YELLOW |
| D-05.4 | 2 | 3 | 2 | 3 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-06.1 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-06.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-06.3 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-06.4 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-07.1 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-07.2 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-07.3 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-07.4 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-08.1 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-08.2 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 | 1 | YELLOW |
| D-09.1 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 | 1 | YELLOW |
| D-09.3 | 3 | 4 | 3 | 4 | N/A | N/A | 1 | 1 | N/A | 1 | 1 | YELLOW |
| D-09.4 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 | 1 | YELLOW |
| D-10.1 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 | 1 | YELLOW |
| D-10.2 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 | 1 | YELLOW |
| D-10.3 | 3 | 4 | 3 | 4 | 3 | 4 | 1 | 1 | 1 | 1 | 1 | YELLOW |
...
- **§3 coverage:** 38 CR + 40 BPR = 78 YAML blocks. BPR-D-* count = 40 unique (matches `11_Rules_Catalog.md` BPR list with `BPR-D-*` prefix including D-12 cross-domain BPR). BPR-D-02.2 maps to D-06.2 (SBOM), BPR-D-02.3 maps to D-02.2 (vulnerability mgmt) — cross-domain mappings preserved.
...
|---------|------|--------|---------|
| 1.0 | 2026-08-07 | Executor (Bloco C) | Initial release — Case_03 unified matrix (3 frameworks CSF + Privacy FW + AI RMF) + triple maturity. 38 CR + 40 BPR = 78 cards. §1-§8 present. Tensions T-001..T-005 cross-referenced in §2.5 and §6.7. AI RMF column ACTIVE (DORA + AI Act both applicable for Case_03). DF9 SHOULD=5 finding documented in §6.6. DORA Art. 5-6 ICT governance + Art. 9 ICT risk management framework explicitly referenced in §2.5 + §6.7. |

---

## See also

- `02_CASES/Case_03_OmniBank_Financial/02_PHASE2_RULES/11_Rules_Catalog.md` — 38 CR + 40 BPR (+ 5 BPR-D-12 cross-domain); the 40 BPR-D-* used here are the 7 from §5.1 + 10 from §9.1 + 4 from §9.2 + 4 cross-domain).
- `02_CASES/Case_03_OmniBank_Financial/02_PHASE2_RULES/09_Strategic_Tensions_Report.md` — 4 tensions (T-001..T-004) + T-005 from Sprint 1; T-001..T-005 are all referenced in §2.5 and §6.7.
- `02_CASES/Case_03_OmniBank_Financial/02_PHASE2_RULES/06_Clause_Mapping_Matrix.md` — 150 clauses (28 GDPR + 26 CRA + 29 NIS 2 + 38 DORA + 29 AI Act) source for §6.6 NI distribution.
- `02_CASES/Case_03_OmniBank_Financial/01_PHASE1_CONTEXT_RICH/07b_Proportionality_Profile.md` — Track B tier per sub-domain (31 RIGOROUS + 7 STANDARD).
- `02_CASES/Case_03_OmniBank_Financial/01_PHASE1_CONTEXT_RICH/04b_Security_Posture.md` — current maturity per sub-domain (cur values in §5.1).
- `02_CASES/Case_03_OmniBank_Financial/01_PHASE1_CONTEXT_RICH/06b_DORA_ICT_Risk_Framework.md` — DORA Art. 5-16 ICT risk framework; DORA-defining characteristics of Case_03 (referenced in §2.5 + §6.7).
...
- `02_CASES/Case_02_SecureBorder_Solutions/02_PHASE2_RULES_RICH/13_Framework_Mapping_Matrix.md` — Case_02 reference for methodology (FN-03 fix for N/A exclusion rule; 3 frameworks).
- `02_CASES/Case_03_OmniBank_Financial/01_PHASE1_CONTEXT_RICH/phase1_ontology.yaml` — clause IDs and NI baseline.
- `02_CASES/Case_03_OmniBank_Financial/01_PHASE1_CONTEXT_RICH/05_Regulatory_Applicability.md` — 5/5 regulations applicable (GDPR, CRA, NIS 2, DORA, AI Act).
