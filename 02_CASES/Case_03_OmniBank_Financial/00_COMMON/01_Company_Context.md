...
| **B4: Security Org** | size ≥50 OR maturity ≥Managed | **ACTIVATED** | Q57-Q61 | *(legacy design text — superseded by IMPLEMENTATION_POSTURE_MODEL_CSF_STRICT.md v2.0, port Fase 4)*
...
> Block B4: **ACTIVATED** — 5000+ employees, securityMaturity = VERY HIGH *(legacy design text — superseded by IMPLEMENTATION_POSTURE_MODEL_CSF_STRICT.md v2.0, port Fase 4)*
...
#### BLOCK B4: Security Organization Maturity Extension *(legacy design text — superseded by IMPLEMENTATION_POSTURE_MODEL_CSF_STRICT.md v2.0, port Fase 4)*
**Trigger:** size ≥50 employees OR securityMaturity ≥ Managed *(legacy design text — superseded by IMPLEMENTATION_POSTURE_MODEL_CSF_STRICT.md v2.0, port Fase 4)*
**Activated:** YES
