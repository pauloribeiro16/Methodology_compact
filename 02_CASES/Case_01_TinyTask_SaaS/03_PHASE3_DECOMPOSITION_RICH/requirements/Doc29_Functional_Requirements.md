...
- `KG_CHAINS.md` §1 CH-09 — FR-29 → UC-21 → CR-D-04.3 (KG node label mismatch F-S2-01).
...
|-------|---------------------------|-----|------|----|----|----|-------|-----------------------|----------|----------|--------------|-----------|
| FR-01 | Register + provision new users | PROC-19, UC-10 | NFR-02 | CR-D-03.1-001 | TEST | HIGH | | | | | | |
| FR-02 | Authenticate + lock after 5 fails + log all attempts | UC-08 | NFR-01..07/20/32/34 | CR-D-03.1-001 | TEST | CRITICAL | | | | | | |
| FR-03 | MFA for privileged accounts | PROC-20 | NFR-01 | CR-D-03.1-001 | DEMONSTRATE | HIGH | | | | | | |
| FR-04 | Deprovision accounts within 24h of termination | PROC-07 | NFR-02 | CR-D-03.1-001 | INSPECT | HIGH | | | | | | |
| FR-05 | Assign roles based on job function | UC-10 | NFR-02, NFR-09 | CR-D-03.1-001 | TEST | HIGH | | | | | | |
| FR-06 | Password reset + 30-min session timeout | UC-08, PROC-06 | NFR-06, NFR-07 | — | TEST | MEDIUM | | | | | | |
...
| FR ID | Requirement | UCs | NFRs | CR | Verif | Prio | Owner | Verification Criteria | Implementation Status | Priority | Stakeholders | Reporting |
|-------|-------------|-----|------|----|----|----|-------|-----------------------|----------|----------|--------------|-----------|
| FR-13 | Collect + correlate security events + alerts | PROC-03, UC-07 | NFR-10, NFR-32 | CR-D-02.1-001 | INSPECT | CRITICAL | | | | | | |
...
| FR-19 | Quarterly access review + BCP activation (RTO 24h) | PROC-05, UC-07 | NFR-02/14..19 | CR-D-03.1-001 | INSPECT | CRITICAL | | | | | | |

### §2.4 DEV domain (FR-20..FR-23)

| FR ID | Requirement | UCs | NFRs | CR | Verif | Prio | Owner | Verification Criteria | Implementation Status | Priority | Stakeholders | Reporting |
|-------|-------------|-----|------|----|----|----|-------|-----------------------|----------|----------|--------------|-----------|
| FR-20 | SAST + dep vuln scan + secret detection per commit | PROC-08, UC-11, UC-12 | NFR-05, NFR-07, NFR-12 | CR-D-07.1-001 | TEST | HIGH | | | | | | |
| FR-21 | Security gates before merge; block on critical | UC-12 | NFR-05/07/11/12 | CR-D-02.1-001 | TEST | CRITICAL | | | | | | |
| FR-22 | Change request submission + approval | PROC-21 | — (process) | — | TEST | MEDIUM | | | | | | |
...
| FR-25 | Annual policy review + periodic RA + DPIA | PROC-10, PROC-12, UC-13 | NFR-31, NFR-36 | CR-D-06.1-001 | INSPECT | HIGH | | | | | | |
...
**Source UC:** PROC-10, PROC-12, UC-13
...
- `KG_CHAINS.md` §1 CH-09 — FR-29 → UC-21
