...
MUC_FREEZE = [
    ...
    ("MUC-02", "A-MIS-03", "U.C.7.5.1, U.C.10.3.1", "U.C.3.2.1, U.C.3.5.1, PROC-11", "Privilege Escalation via Invite/Roles"),
    ("MUC-03", "A-MIS-01/A-MIS-03", "U.C.8.1.2, U.C.8.2.1, U.C.8.3.1, U.C.8.1.1, U.C.10.1.1", "U.C.3.3.1, U.C.3.2.1, PROC-03, U.C.4.2.1", "Cross-Tenant Data Injection/Read"),
    ("MUC-04", "A-MIS-03", "U.C.11.2.1, U.C.9.4.1", "U.C.1.3.1, U.C.1.5.1, U.C.2.4.2, U.C.3.5.1", "Bulk Data Extraction via Export Endpoint"),
    ("MUC-05", "A-MIS-04", "U.C.10.2.1, U.C.7.1.2", "PROC-14, CAP-01, U.C.3.1.1", "Compromised Third-Party Integration"),
...
CONSTRAINS_EDGES = [
    ...
    ("PROC-06", "All U.C.7-11"),
    ("U.C.3.5.1", "All U.C.7-11"),
    ("PROC-07", "All U.C.7-11"),
    ("PROC-08", "U.C.8.*, U.C.10.*"),
    ("U.C.4.2.1", "U.C.8.*, U.C.9.3.1"),
    ("U.C.4.3.1", "All U.C.7-11"),
    ("U.C.4.4.1", "U.C.8.3.1, U.C.9.4.1, U.C.10.1.1"),
    ("PROC-09", "U.C.10.2.1, U.C.10.3.2, U.C.11.x"),
    ("PROC-10", "All U.C.7-11"),
    ("PROC-11", "All U.C.7-11"),
    ("PROC-12", "U.C.10.2.1, U.C.10.3.2, U.C.11.x"),
    ("PROC-13", "All U.C.7-11"),
    ("PROC-14", "U.C.10.2.1, U.C.7.1.2"),
    ("CAP-01", "U.C.10.2.1, U.C.7.1.2"),
    ("U.C.5.6.1", "U.C.8.*, U.C.10.*"),
    ("PROC-15", "All U.C.7-11 (human-driven)"),
    ("PROC-16", "U.C.7.5.1, U.C.10.3.1"),
    ("PROC-17", "U.C.7.1.1, U.C.7.1.2"),
]
...
FR_TO_UC: Dict[str, List[str]] = {
    ...
    "FR-03": ["U.C.3.3.1"], "FR-04": ["PROC-07"],
    "FR-05": ["U.C.3.5.1"], "FR-06": ["U.C.3.1.1", "PROC-06"],
    "FR-07": ["PROC-01"], "FR-08": ["U.C.1.2.1"],
    "FR-09": ["U.C.1.3.1"], "FR-10": ["U.C.1.4.1"],
    "FR-11": ["U.C.1.5.1"], "FR-12": ["U.C.1.4.1"],
    "FR-13": ["PROC-03", "U.C.2.6.1"], "FR-14": ["PROC-03"],
    "FR-15": ["U.C.2.2.1"], "FR-16": ["U.C.1.6.1 (legacy)", "U.C.2.2.1"],
    "FR-17": ["PROC-04"], "FR-18": ["U.C.2.4.1"],
    "FR-19": ["PROC-05"], "FR-20": ["PROC-08", "U.C.4.2.1", "U.C.4.3.1"],
