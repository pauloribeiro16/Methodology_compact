...
UC_FREEZE = [
    ("U.C.1.1.1", "DP", "D-01.1", "Data Subject Access Request"),
    ("U.C.1.1.2", "DP", "D-01.4", "Data Subject Rectification"),
    ("U.C.1.2.1", "DP", "D-05.3", "Data Subject Erasure"),
    ("U.C.1.3.1", "DP", "D-05.1", "Data Subject Data Export"),
    ("U.C.1.4.1", "DP", "D-05.2", "Consent Management"),
    ("U.C.1.5.1", "DP", "D-05.4", "Data Portability"),
    ("U.C.2.1.1", "SEC", "D-02.1", "Vulnerability-Free Release"),
    ("U.C.2.2.1", "SEC", "D-02.2", "Automated Patch Deployment"),
    ("U.C.2.3.1", "SEC", "D-02.3", "Coordinated Vulnerability Disclosure"),
    ("U.C.2.4.1", "SEC", "D-04.1", "Exploit Severity Limitation"),
    ("U.C.2.4.2", "SEC", "D-04.2", "DoS Resilience"),
    ("U.C.2.5.1", "SEC", "D-04.3", "Incident Notification (24h)"),
    ("U.C.2.6.1", "SEC", "D-04.4", "Data Restoration and Recovery"),
    ("U.C.3.1.1", "IAM", "D-03.1", "User Authentication"),
    ("U.C.3.1.2", "IAM", "D-03.2", "MFA for Privileged Accounts"),
    ("U.C.3.2.1", "IAM", "D-03.3", "Authorisation / Least Privilege"),
    ("U.C.3.3.1", "IAM", "D-03.4", "Secure System Defaults"),
    ("U.C.3.4.1", "IAM", "D-09.4", "Processing & Breach Records"),
    ("U.C.3.5.1", "IAM", "D-10.2", "Audit Logging"),
    ("U.C.3.6.1", "IAM", "D-10.3", "Control Effectiveness Testing"),
    ("U.C.4.1.1", "DEV", "D-07.1", "Security by Design"),
    ("U.C.4.2.1", "DEV", "D-07.2", "SAST/DAST in CI/CD"),
    ("U.C.4.3.1", "DEV", "D-02.2", "Security Patch Deployment"),
    ("U.C.4.4.1", "DEV", "D-04.1", "Fail-Safe Design"),
    ("U.C.4.5.1", "DEV", "D-09.2", "Pre-Launch Risk Assessment"),
    ("U.C.5.1.1", "GOV", "D-09.1", "Annual Policy Review"),
    ("U.C.5.1.2", "GOV", "D-09.1", "Technical Documentation Maintenance"),
    ("U.C.5.2.1", "GOV", "D-09.2", "DPIA Pre-Launch"),
    ("U.C.5.3.1", "GOV", "D-09.4", "RoPA Maintenance"),
    ("U.C.5.4.1", "GOV", "D-06.1", "Processor Due Diligence"),
    ("U.C.5.5.1", "GOV", "D-06.3", "DPAs Binding Processors"),
    ("U.C.5.6.1", "GOV", "D-06.2", "SBOM Publication"),
...
FR_TO_UC: Dict[str, List[str]] = {
    "FR-01": ["U.C.3.2.1", "U.C.3.5.1"], "FR-02": ["U.C.3.1.1"],
    "FR-03": ["U.C.3.3.1"], "FR-04": ["U.C.3.6.1"],
    "FR-05": ["U.C.3.5.1"], "FR-06": ["U.C.3.1.1", "U.C.3.4.1"],
    "FR-07": ["U.C.1.1.1"], "FR-08": ["U.C.1.2.1"],
    "FR-09": ["U.C.1.3.1"], "FR-10": ["U.C.1.4.1"],
    "FR-11": ["U.C.1.5.1"], "FR-12": ["U.C.1.4.1"],
    "FR-13": ["U.C.2.1.1", "U.C.2.6.1"], "FR-14": ["U.C.2.1.1"],
    "FR-15": ["U.C.2.2.1"], "FR-16": ["U.C.1.6.1 (legacy)", "U.C.2.2.1"],
    "FR-17": ["U.C.2.3.1"], "FR-18": ["U.C.2.4.1"],
    "FR-19": ["U.C.2.5.1"], "FR-20": ["U.C.4.1.1", "U.C.4.2.1", "U.C.4.3.1"],
    "FR-21": ["U.C.4.3.1"], "FR-22": ["U.C.4.4.1"],
    "FR-23": ["U.C.4.5.1"], "FR-24": ["U.C.5.7.1 (legacy)"],
    "FR-25": ["U.C.5.1.1", "U.C.5.2.1"], "FR-26": ["U.C.5.3.1"],
    "FR-27": ["U.C.5.4.1"], "FR-28": ["U.C.5.5.1"],
    "FR-29": ["U.C.6.1.1", "U.C.6.2.1"], "FR-30": ["U.C.6.3.1"],
}
