...
flowchart TD
    ...
    UC_7_1_1(L2: UC-18 Sign Up)
    UC_7_1_2(L2: UC-19 Login)
    UC_7_1_3(L2: UC-20 Password Reset)
    UC_7_2_1(L2: UC-21 Session Mgmt)
    UC_7_5_1(L2: UC-22 Invite+Roles)
    UC_8_1_1(L2: UC-23 Workspace)
    UC_8_1_2(L2: UC-24 Project)
    UC_8_2_1(L2: UC-25 Create Task)
    UC_8_2_2(L2: UC-26 Assign Task)
    UC_8_2_3(L2: UC-27 Status/Due)
    UC_8_3_1(L2: UC-28 Board View)
    UC_9_1_1(L2: UC-29 Comment)
    UC_9_2_1(L2: UC-30 Mention+Notify)
    UC_9_3_1(L2: UC-31 Attachment)
    UC_9_4_1(L2: UC-32 Search)
    UC_9_5_1(L2: UC-33 Activity Feed)
    UC_10_1_1(L2: UC-34 Mobile Sync)
    UC_10_2_1(L2: UC-35 Stripe Checkout)
    UC_10_3_1(L2: UC-36 Admin Console)
    UC_10_3_2(L2: UC-37 Enterprise SSO)
    UC_11_1_1(L2: UC-38 View Account)
    UC_11_2_1(L2: UC-39 Export Data)
    UC_11_3_1(L2: UC-40 Delete Account)
    ...
    UC_2_4_2(L2: UC-07 DoS Resilience)
    UC_2_5_1(L2: PROC-05 Incident Notification)
    UC_2_6_1(L2: UC-08 Data Restoration)
    UC_3_1_1(L2: UC-09 Authentication)
    UC_3_1_2(L2: UC-10 MFA Privileged)
    UC_3_2_1(L2: UC-11 Authorisation)
    UC_3_3_1(L2: UC-12 Secure Defaults)
    UC_3_4_1(L2: PROC-06 Processing Records)
    UC_3_5_1(L2: UC-13 Audit Logging)
    UC_3_6_1(L2: PROC-07 Control Testing)
    UC_4_1_1(L2: PROC-08 Security by Design)
    UC_4_2_1(L2: UC-14 SAST/DAST)
    UC_4_3_1(L2: UC-15 Patch Deploy)
    UC_4_4_1(L2: UC-16 Fail-Safe)
...
| L2 (functional) | 23 | UC-18..UC-40 IDs (see Doc20 §2) | — |
