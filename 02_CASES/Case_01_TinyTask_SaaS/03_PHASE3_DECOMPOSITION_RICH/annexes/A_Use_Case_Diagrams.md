...
graph TB
    ...
    subgraph PKG_IAM[PKG-IAM: Identity & Access]
        ...
        UC35[U.C.3.4.1 Processing Records]
        UC36[U.C.3.5.1 Audit Logging]
        UC37[U.C.3.6.1 Control Testing]
    end
    subgraph PKG_DEV[PKG-DEV: Secure Development]
        UC41[U.C.4.1.1 Security by Design]
        UC42[U.C.4.2.1 SAST/DAST]
        UC43[U.C.4.3.1 Patch Deploy]
        UC44[U.C.4.4.1 Fail-Safe]
        UC45[U.C.4.5.1 Pre-Launch RA]
    end
    subgraph PKG_GOV[PKG-GOV: Governance & Compliance]
        UC51[U.C.5.1.1 Policy Review]
        UC52[U.C.5.1.2 Tech Docs]
        UC53[U.C.5.2.1 DPIA]
        UC54[U.C.5.3.1 RoPA]
        UC55[U.C.5.4.1 Processor DD]
        UC56[U.C.5.5.1 DPA]
        UC57[U.C.5.6.1 SBOM]
    end
    subgraph PKG_TRN[PKG-TRN: Training & Awareness]
        UC61[U.C.6.1.1 Annual Training]
        UC62[U.C.6.2.1 Role-Specific]
        UC63[U.C.6.3.1 Phishing Sim]
    end
```
