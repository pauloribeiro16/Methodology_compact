---
document_id: AEGIS-P2-RICH-01-INTAKE
...
reconciliation:
  ...
  notes: |
    ...
    - applicable_regs: [GDPR, CRA, NIS 2, AI_Act] (excludes DORA per Case_02 profile).
...
<!-- RECONCILIATION BANNER (Sprint 1, 2026-08-06):
     This is the Rich Mode copy of AEGIS-COMMON-01 (legacy filename: 01_Company_Context.md).
     Source: ../00_COMMON/01_Company_Context.md.
     Body unchanged from legacy. Sprint 2 will add corpus linkages (L1/L2/L4 HSO refs).
...
│       └── NO → ...    │
│
└── NO → AI_Act: NOT APPLICABLE
```

| Decision Point | Answer | AI_Act Applicable? |
|----------------|--------|---------------------|
...
| AI_Act | **YES** | HIGH | DEPLOYER + PROVIDER | Annex III border control AI |
...
**Trigger:** AI_Act applicable
**Activated:** YES

| Question | Response | Notes |
|----------|----------|-------|
| Q39: AI System Classification | Annex III use case (border control AI) | AI_Act Annex III: migration and border control management |
...
| Q74: Cross-Regulation Role Implications | CRA=manufacturer; GDPR=processor; AI_Act=deployer | Multiple roles across applicable regulations |
...
**Required when:** 4+ regulations applicable — **ACTIVE (GDPR + CRA + NIS 2 + AI_Act)**
...
| TC-003 | AI_Act Art. 73 | 15 days (standard) | NIS 2 Art. 23 | 24h (incident) | Different triggers | Separate workflows |
...
|-------------|----------------|-----------|-----------|----------|------------|
| TM-001 | DPIA / FRIA | GDPR: large-scale Art. 9 | AI_Act: high-risk AI | Different scope, timing | Unified DPIA/FRIA approach |

### 5.4 Scan 4: Negative Analysis Checklist

| Item | Regulation | Provision | Non-Applicability Confirmed? | Rationale |
|------|-----------|-----------|------------------------------|-----------|
| NA-001 | AI_Act | Art. 5 (Prohibited) | YES | Biometrics not for prohibited purposes |
...
| AI_Act | YES | Annex III AI system = TRUE | YES | HIGH |
...
| DORA | — | — | — | NOT APPLICABLE |
| AI_Act | DEPLOYER + PROVIDER | Art. 9-15 high-risk requirements, Art. 72 post-market | Via Art. 25 agreements | Annex III high-risk AI |
...
|-----------|-----------|--------|
| Number of applicable regulations | ≥4 | HIGH (4 regulations: GDPR, CRA, NIS 2, AI_Act) |
| | 2-3 | |
...
CompanyContext {
    ...
    crossRegulationRoles: "CRA=manufacturer; GDPR=processor; AI_Act=deployer"
