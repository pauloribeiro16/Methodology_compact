...
created: 2026-07-11
updated: 2026-08-07
author: Executor (Sprint 2 Corpus Enrichment, 2026-08-06; Phase 2 Bloco E maturity deprecation)
...
### D-01 Data Protection — Maturity: 3
...
**Target maturity**: 3 (some sub-targets 4 — see Regulatory Baseline fit criteria for D-01.4)
...
### D-02 Vulnerability Management — Maturity: 3
...
**Target maturity**: 3 (D-02.4 pen testing per CRA + AI_Act is level 3 requirement)
**Gap**: 0
...
### D-03 Access Control — Maturity: 3
...
**Target maturity**: 4 (for D-03.3 due to NIS 2 + AI_Act privileged access requirements)
...
### D-07 Secure Development — Maturity: 3
...
**Target maturity**: 4 (for D-07.4 under AI_Act Annex III change-control requirements)
...
### D-09 Governance & Documentation — Maturity: 3
...
### D-10 Monitoring & Audit — Maturity: 3
...
**Target maturity**: 4 (for D-10.2 audit logging given cryptographic hash chain)
...
|---|---|---|---|
| 1.0 | 2026-07-11 | Executor | Created SecureBorder populated security posture assessment from the 04b template; HIGH-tier maturity averaging 3.0 (vs TinyTask's 1.3), with D-08.3 ACTIVE (NIS 2-applicable). |
